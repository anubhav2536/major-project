              ...
              {incidents.length &&
                incidents.map((incident, index) => (
                  <tr key={index} className="text-gray-600">
                    ...
                    <td className="border px-4 py-2">{incident.details}</td>
                    <td
                    ...
                    <td className="border px-4 py-2">
                      {new Date(incident.reportedDateTime).toLocaleDateString()}{" "}
                      &{" "}
                      {new Date(incident.reportedDateTime).toLocaleTimeString()}
                    </td>
                    <td className="border px-4 py-2">
                      <span
